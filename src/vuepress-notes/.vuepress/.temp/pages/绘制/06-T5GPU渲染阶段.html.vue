<template><div><h1 id="t5-gpu-渲染阶段-渲染到屏幕" tabindex="-1"><a class="header-anchor" href="#t5-gpu-渲染阶段-渲染到屏幕"><span>T5：GPU 渲染阶段（渲染到屏幕）</span></a></h1>
<table>
<thead>
<tr>
<th>项目</th>
...
<h2 id="gpu-渲染管线-rendering-pipeline" tabindex="-1"><a class="header-anchor" href="#gpu-渲染管线-rendering-pipeline"><span>GPU 渲染管线（Rendering Pipeline）</span></a></h2>
...
<h2 id="双缓冲机制-double-buffering" tabindex="-1"><a class="header-anchor" href="#双缓冲机制-double-buffering"><span>双缓冲机制（Double Buffering）</span></a></h2>
<table>
<thead>
<tr>
<th>Buffer</th>
...
<h2 id="vsync-信号的作用" tabindex="-1"><a class="header-anchor" href="#vsync-信号的作用"><span>VSync 信号的作用</span></a></h2>
<table>
<thead>
<tr>
<th>作用</th>
...
<h2 id="显示到屏幕" tabindex="-1"><a class="header-anchor" href="#显示到屏幕"><span>显示到屏幕</span></a></h2>
<table>
<thead>
<tr>
<th>步骤</th>
