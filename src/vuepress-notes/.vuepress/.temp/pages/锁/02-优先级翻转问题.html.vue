<template><div><h1 id="优先级翻转问题" tabindex="-1"><a class="header-anchor" href="#优先级翻转问题"><span>优先级翻转问题</span></a></h1>
<h2 id="_1-什么是优先级翻转" tabindex="-1"><a class="header-anchor" href="#_1-什么是优先级翻转"><span>1. 什么是优先级翻转</span></a></h2>
<p>优先级翻转（Priority Inversion）是操作系统调度中的一个异常现象：高优先级线程因为等待低优先级线程持有的资源，导致高优先级线程晚于低优先级线程（甚至中优先级线程）执行，违背了优先级调度的预期。</p>
<h2 id="_2-qos-ios-中的线程优先级" tabindex="-1"><a class="header-anchor" href="#_2-qos-ios-中的线程优先级"><span>2. QoS：iOS 中的线程优先级</span></a></h2>
<p>在 iOS/macOS 中，线程的优先级通过 <strong>QoS（Quality of Service，服务质量）</strong> 来标识。QoS 决定了线程的优先级，进而影响线程调度和优先级翻转问题。</p>
<h3 id="_2-1-qos-的引入" tabindex="-1"><a class="header-anchor" href="#_2-1-qos-的引入"><span>2.1 QoS 的引入</span></a></h3>
<p><strong>QoS 是在 iOS 8（2014年）中引入的</strong>，用于替代之前的数字优先级系统（如 <code v-pre>DISPATCH_QUEUE_PRIORITY_HIGH</code>、<code v-pre>DISPATCH_QUEUE_PRIORITY_LOW</code>）。</p>
<table>
<thead>
<tr>
<th>时间点</th>
...
<td><code v-pre>OSSpinLock</code> 更容易出现优先级翻转问题</td>
</tr>
<tr>
<td><strong>iOS 10（2016年）</strong></td>
<td>推出 <code v-pre>os_unfair_lock</code>，支持优先级继承</td>
<td>解决 <code v-pre>OSSpinLock</code> 的优先级翻转问题</td>
</tr>
</tbody>
</table>
<h3 id="_2-2-qos-等级" tabindex="-1"><a class="header-anchor" href="#_2-2-qos-等级"><span>2.2 QoS 等级</span></a></h3>
...
<h3 id="_2-3-qos-如何影响优先级翻转问题" tabindex="-1"><a class="header-anchor" href="#_2-3-qos-如何影响优先级翻转问题"><span>2.3 QoS 如何影响优先级翻转问题</span></a></h3>
...
<td><code v-pre>os_unfair_lock</code> 通过优先级继承，临时将低 QoS 线程提升到高 QoS 级别</td>
...
<h2 id="_3-锁的类型与优先级翻转" tabindex="-1"><a class="header-anchor" href="#_3-锁的类型与优先级翻转"><span>3. 锁的类型与优先级翻转</span></a></h2>
...
<h3 id="_4-3-为什么-l-会被饿死" tabindex="-1"><a class="header-anchor" href="#_4-3-为什么-l-会被饿死"><span>4.3 为什么 L 会被饿死？</span></a></h3>
...
<h2 id="_5-互斥锁的优先级翻转问题" tabindex="-1"><a class="header-anchor" href="#_5-互斥锁的优先级翻转问题"><span>5. 互斥锁的优先级翻转问题</span></a></h2>
<p>对于互斥锁（如 <code v-pre>pthread_mutex</code>、<code v-pre>NSLock</code>、<code v-pre>dispatch_semaphore</code>），当获取不到锁时，线程会进入**睡眠（Sleep）**状态并主动让出 CPU。</p>
<h3 id="_5-1-两个线程的情况" tabindex="-1"><a class="header-anchor" href="#_5-1-两个线程的情况"><span>5.1 两个线程的情况</span></a></h3>
...
<h2 id="_6-解决方案-os-unfair-lock-与优先级继承" tabindex="-1"><a class="header-anchor" href="#_6-解决方案-os-unfair-lock-与优先级继承"><span>6. 解决方案：os_unfair_lock 与优先级继承</span></a></h2>
<p>为了解决自旋锁的活锁问题和互斥锁的优先级翻转问题，苹果在 iOS 10 推出了 <code v-pre>os_unfair_lock</code> 作为 <code v-pre>OSSpinLock</code> 的替代。</p>
<h3 id="_6-1-os-unfair-lock-是什么类型的锁" tabindex="-1"><a class="header-anchor" href="#_6-1-os-unfair-lock-是什么类型的锁"><span>6.1 os_unfair_lock 是什么类型的锁？</span></a></h3>
<p><code v-pre>os_unfair_lock</code> <strong>不是纯自旋锁</strong>，而是一种<strong>自适应锁（Adaptive Lock）</strong>：</p>
<table>
<thead>
<tr>
<th>场景</th>
...
<blockquote>
<p><strong>说明</strong>：Apple 官方文档没有详细说明自旋和睡眠切换的具体阈值，这是系统内部的实现细节。但可以确定的是，<code v-pre>os_unfair_lock</code> 会根据实际情况在自旋和睡眠之间自适应切换，而不是像 <code v-pre>OSSpinLock</code> 那样一直自旋。</p>
</blockquote>
<h3 id="_6-2-优先级继承机制" tabindex="-1"><a class="header-anchor" href="#_6-2-优先级继承机制"><span>6.2 优先级继承机制</span></a></h3>
<p><code v-pre>os_unfair_lock</code> 与系统内核调度紧密结合，并利用了**优先级继承（Priority Inheritance）**机制：</p>
<table>
<thead>
<tr>
<th>步骤</th>
...
<td>3</td>
<td>L 的优先级和 H 一样高</td>
<td>**解决互斥锁的 M 抢占问题：**中优先级线程 M 无法再抢占 L 的 CPU，L 得以不受干扰地快速执行完临界区代码并释放锁</td>
</tr>
<tr>
<td>4</td>
<td>在多核环境下，L 更有可能被调度到空闲核心执行。如果等待时间过长，H 会进入睡眠</td>
<td>**解决自旋锁的活锁问题：**避免浪费 CPU</td>
</tr>
<tr>
<td>5</td>
...
<h3 id="_6-3-优先级继承与自适应机制的配合" tabindex="-1"><a class="header-anchor" href="#_6-3-优先级继承与自适应机制的配合"><span>6.3 优先级继承与自适应机制的配合</span></a></h3>
...
<h3 id="_7-1-优先级翻转是死锁吗" tabindex="-1"><a class="header-anchor" href="#_7-1-优先级翻转是死锁吗"><span>7.1 优先级翻转是死锁吗？</span></a></h3>
...
<h3 id="_7-2-为什么-osspinlock-能用这么久才被废弃" tabindex="-1"><a class="header-anchor" href="#_7-2-为什么-osspinlock-能用这么久才被废弃"><span>7.2 为什么 OSSpinLock 能用这么久才被废弃？</span></a></h3>
<p>主要原因：</p>
<table>
<thead>
<tr>
